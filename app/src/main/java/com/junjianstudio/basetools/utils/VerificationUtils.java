...
public class VerificationUtils {
    ...
    public static boolean australiaNumber(String value){
        String regex = "^(0[0-9])\\d{8}$";
        return testRegex(regex, value);
    }

    public static boolean australiaPhone(String value){
        String regex = "^(04[0-9])\\d{7}$";
        return testRegex(regex, value);
    }

    public static boolean chinaPhone(String value){
